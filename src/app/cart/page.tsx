...
const Page = () => {
    ...
    return <div className="bg-white">
        <div className="mt-auto max-w-2xl px-4 pb-24 pt-16 sm\:px-6 lg:max-w-7xl lg:px-8">
            <h1 className="text-3l font-bold tracking-tight text-gray-900 sm:text-4xl">Shopping Cart</h1>
            ...
            <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                <div className={cn("lg:col-span-7", {
                    ...
                    {isMounted && items.length === 0 ? (
                        <div className="flex h-full flex-col items-center justify-center space-y1">
                            <div
                                aria-hidden="true"
